...
var hdEightyX = 1920 * 0.81;    // 80% HDx
var scaleX;
var scaleX_00 = 100;
var scaleX_01 = myCompSize[0] / hdEightyX * 100;    // zmensujem od 80% HD
var scaleX_02 = myCompSize[0] / 1920 * 100; // zvetsujem nad 1920

if (myCompSize[0] >= hdEightyX && myCompSize[0] <= 1920) {
    scaleX = scaleX_00;
} else if (myCompSize[0] < hdEightyX) {
    scaleX = scaleX_01;
} else if (myCompSize[0] > 1920) {
    scaleX = scaleX_02;
}

var hdEightyY = 1080 * 0.81;    // 80% HDx
var scaleY;
var scaleY_00 = 100;
var scaleY_01 = myCompSize[1] / hdEightyY * 100;    // zmensujem od 80% HD
var scaleY_02 = myCompSize[1] / 1080 * 100; // zvetsujem nad 1920

if (myCompSize[1] >= hdEightyY && myCompSize[1] <= 1080) {
    scaleY = scaleY_00;
} else if (myCompSize[1] < hdEightyY) {
    scaleY = scaleY_01;
